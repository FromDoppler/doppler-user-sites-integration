...
print_help () {
    ...
    echo
    echo "Examples:"
    echo "  sh build-n-publish.sh --image=dopplerdock/doppler-user-sites-integration --commit=aee25c286a7c8265e2b32ccc293f5ab0bd7a9d57 --version=v1.2.11"
    echo "  sh build-n-publish.sh --image=dopplerdock/doppler-user-sites-integration --commit=e247ba0527665eb9dd7ffbff00bb42e5073cd457 --version=v0.0.0 --pre-version-suffix=commit-e247ba0527665eb9dd7ffbff00bb42e5073cd457"
    echo "  sh build-n-publish.sh -i=dopplerdock/doppler-user-sites-integration -c=94f85efb9c3689f409104ef7cde6813652ca59fb -v=v12.34.5"
    echo "  sh build-n-publish.sh -i=dopplerdock/doppler-user-sites-integration -c=94f85efb9c3689f409104ef7cde6813652ca59fb -v=v12.34.5 -s=beta1"
    echo "  sh build-n-publish.sh -i=dopplerdock/doppler-user-sites-integration -c=94f85efb9c3689f409104ef7cde6813652ca59fb -v=v12.34.5 -s=pr123"
}
